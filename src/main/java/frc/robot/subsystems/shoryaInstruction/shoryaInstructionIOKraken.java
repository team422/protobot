...
public class shoryaInstructionIOKraken implements shoryaInstructionIO {
  ...
  public shoryaInstructionIOKraken(int port) {
    ...
    var feedback = new FeedbackConfigs().withSensorToMechanismRatio(ShoryaConstants.kGearRatio);
  ...
  public void setDesiredAngle(Rotation2d angle) {
    ...
    value =
        MathUtil.clamp(
            value,
            ShoryaConstants.kshoryaInstructionMinAngle.getRadians(),
            ShoryaConstants.kshoryaInstructionMaxAngle.getRadians());
