...
public final class Constants {
  ...
  public static final class Ports {
    ...
    public static final CANBus kDriveCanivoreName = new CANBus("Drivetrain");

    public static final int kIntake = 12;

    public static final CANBus kMainCanivoreName = new CANBus("Main");
  }
